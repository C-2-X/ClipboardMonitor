...
class MaterialButtonHelper {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z) {
        if (this.rippleDrawable != null && this.rippleDrawable.getNumberOfLayers() > 0) {
            ...
            if (z2) {
                return (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) layerDrawable.getDrawable(0)).getDrawable()).getDrawable(!z ? 1 : 0);
            }
            return (MaterialShapeDrawable) layerDrawable.getDrawable(!z ? 1 : 0);
        }
        return null;
    }
    ...
    public Shapeable getMaskDrawable() {
        if (this.rippleDrawable != null && this.rippleDrawable.getNumberOfLayers() > 1) {
            ...
            LayerDrawable layerDrawable = this.rippleDrawable;
            if (numberOfLayers > 2) {
                return (Shapeable) layerDrawable.getDrawable(2);
            }
            return (Shapeable) layerDrawable.getDrawable(1);
        }
        return null;
    }
