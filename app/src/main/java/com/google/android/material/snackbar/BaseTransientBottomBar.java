...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public void updateMargins() {
        ...
        if ((marginChanged || this.appliedBottomMarginGestureInset != this.extraBottomMarginGestureInset) && shouldUpdateGestureInset()) {
    ...
    public void startSlideInAnimation() {
        ...
        if (z) {
            ViewCompat.offsetTopAndBottom(snackbarBaseLayout, translationYBottom);
        } else {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.14
            ...
            public void onAnimationUpdate(ValueAnimator animator2) {
                ...
                BaseTransientBottomBar baseTransientBottomBar = BaseTransientBottomBar.this;
                if (z2) {
                    ViewCompat.offsetTopAndBottom(baseTransientBottomBar.view, currentAnimatedIntValue - this.previousAnimatedIntValue);
                } else {
                    baseTransientBottomBar.view.setTranslationY(currentAnimatedIntValue);
                }
