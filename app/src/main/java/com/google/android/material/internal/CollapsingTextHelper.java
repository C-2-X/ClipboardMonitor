...
public final class CollapsingTextHelper {
    ...
    private void calculateOffsets(float fraction) {
        ...
        if (colorStateList != colorStateList2) {
            textPaint.setColor(blendARGB(getCurrentExpandedTextColor(), getCurrentCollapsedTextColor(), textBlendFraction));
        } else {
        ...
        if (f != f2) {
            textPaint2.setLetterSpacing(lerp(this.expandedLetterSpacing, this.collapsedLetterSpacing, fraction, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        } else {
