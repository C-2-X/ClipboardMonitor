...
class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T>, SelectClause1<T> {
    ...
    static /* synthetic */ Object await$suspendImpl(DeferredCoroutine deferredCoroutine, Continuation $completion) {
        Object objAwaitInternal$kotlinx_coroutines_core = deferredCoroutine.awaitInternal$kotlinx_coroutines_core($completion);
