...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM170constructorimpl = Result.m170constructorimpl(ResultKt.createFailure(th));
        }
        if (objNewInstance != null) {
            objM170constructorimpl = Result.m170constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m176isFailureimpl(objM170constructorimpl)) {
                objM170constructorimpl = null;
            }
            return (Function1) objM170constructorimpl;
        }
        ...
        try {
            try {
                ...
                for (Object element$iv$iv2 : $this$associateBy$iv) {
                    ...
                    jobToStack.put(job2, it3.info);
                }
                StringBuilder $this$hierarchyToString_u24lambda_u2d9_u24lambda_u2d8 = new StringBuilder();
                INSTANCE.build(job, jobToStack, $this$hierarchyToString_u24lambda_u2d9_u24lambda_u2d8, HttpUrl.FRAGMENT_ENCODE_SET);
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        String str = '[' + CollectionsKt.joinToString$default(coroutinesInfoAsJson, null, null, null, 0, null, null, 63, null) + ']';
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        for (StackTraceElement element : listEnhanceStackTraceWithThreadDump) {
            ...
            stackTraceElementsInfoAsJson.add(StringsKt.trimIndent(sbAppend.append(fileName != null ? toStringWithQuotes(fileName) : null).append(",\n                    \"lineNumber\": ").append(element.getLineNumber()).append("\n                }\n                ").toString()));
        }
        ...
        try {
            if (INSTANCE.isInstalled$kotlinx_coroutines_core()) {
                ...
                for (Object element$iv : $this$forEach$iv) {
                    ...
                    List<StackTraceElement> listEnhanceStackTraceWithThreadDumpImpl = INSTANCE.enhanceStackTraceWithThreadDumpImpl(info.get_state(), info.lastObservedThread, listLastObservedStackTrace);
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM170constructorimpl = Result.m170constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM170constructorimpl = Result.m170constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) objM170constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
        int index$iv = 0;
