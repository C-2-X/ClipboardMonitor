...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM170constructorimpl = Result.m170constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM170constructorimpl = Result.m170constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m176isFailureimpl(objM170constructorimpl) ? null : objM170constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1688installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1688installSignalHandler$lambda1(Signal it) {
