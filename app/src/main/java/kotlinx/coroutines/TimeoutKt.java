...
public final class TimeoutKt {
    ...
    public static final <T> Object m1658withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1650toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m1659withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1650toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
