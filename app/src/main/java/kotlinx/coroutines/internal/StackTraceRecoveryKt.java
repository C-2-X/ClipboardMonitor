...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM170constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM170constructorimpl = Result.m170constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM170constructorimpl = Result.m170constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m173exceptionOrNullimpl(objM170constructorimpl) == null) {
            obj2 = objM170constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM170constructorimpl2 = Result.m170constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM170constructorimpl2 = Result.m170constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m173exceptionOrNullimpl(objM170constructorimpl2) == null) {
            obj = objM170constructorimpl2;
        }
    ...
    private static final <E extends Throwable> E sanitizeStackTrace(E e) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (i2 == 0) {
                ...
                stackTraceElementArtificialFrame = stackTrace[(startIndex + i2) - 1];
            }
            trace[i2] = stackTraceElementArtificialFrame;
        }
