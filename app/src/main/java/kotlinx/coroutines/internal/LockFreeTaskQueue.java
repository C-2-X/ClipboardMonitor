...
public class LockFreeTaskQueue<E> {
    ...
    public final void close() {
        while (true) {
            LockFreeTaskQueueCore cur = (LockFreeTaskQueueCore) this._cur;
            if (cur.close()) {
                return;
            } else {
