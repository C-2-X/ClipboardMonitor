...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo1711dispatch(context, this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00fb A[Catch: all -> 0x012a, TryCatch #7 {all -> 0x012a, blocks: (B:39:0x00f5, B:57:0x0122, B:41:0x00fb, B:48:0x010a, B:52:0x0114, B:50:0x0110), top: B:89:0x00ad }] */
    /*
    ...
    */
    ...
    public final boolean resumeCancelled(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m170constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
