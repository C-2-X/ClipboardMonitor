...
public final class FastServiceLoader {
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        try {
            ...
            MainDispatcherFactory $this$loadMainDispatcherFactory_u24lambda_u2d1 = null;
            try {
                $this$loadMainDispatcherFactory_u24lambda_u2d0 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(Class.forName("kotlinx.coroutines.android.AndroidDispatcherFactory", true, MainDispatcherFactory.class.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            ...
            try {
                $this$loadMainDispatcherFactory_u24lambda_u2d1 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(Class.forName("kotlinx.coroutines.test.internal.TestMainDispatcherFactory", true, MainDispatcherFactory.class.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
