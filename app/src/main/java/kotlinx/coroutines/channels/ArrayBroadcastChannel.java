...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00b3, code lost:
        ...
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L52;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x00bd, code lost:
        ...
        if (r2 != kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN) goto L48;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x00d9, code lost:
        ...
        r24.buffer[(int) (r10 % ((long) r24.capacity))] = r3.getElement();
        setSize(r22 + 1);
        setTail(r10 + 1);
    ...
    */
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r25, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r26) throws java.lang.Throwable {
        /*
