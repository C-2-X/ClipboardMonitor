...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1655SupervisorJob(Job parent) {
        return SupervisorJob(parent);
    }

    /* JADX INFO: renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1656SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1655SupervisorJob(job);
    }
