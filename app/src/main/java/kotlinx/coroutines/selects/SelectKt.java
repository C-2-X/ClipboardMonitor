...
public final class SelectKt {
    ...
    public static final <R> void m1723onTimeout8Mi8wO0(SelectBuilder<? super R> selectBuilder, long timeout, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        selectBuilder.onTimeout(DelayKt.m1650toDelayMillisLRDsOJo(timeout), function1);
    }
    ...
    public static final <R> Object select(Function1<? super SelectBuilder<? super R>, Unit> function1, Continuation<? super R> continuation) {
        SelectInstance scope = new SelectInstance(continuation);
        try {
