...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo1711dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            block2 = block;
            try {
                CoroutineScheduler.dispatch$default(this.coroutineScheduler, block2, null, false, 6, null);
            } catch (RejectedExecutionException e) {
                DefaultExecutor.INSTANCE.mo1711dispatch(context, block2);
            }
    ...
    public void dispatchYield(CoroutineContext context, Runnable block) {
        ...
        try {
            block2 = block;
            try {
                CoroutineScheduler.dispatch$default(this.coroutineScheduler, block2, null, true, 2, null);
            } catch (RejectedExecutionException e) {
                DefaultExecutor.INSTANCE.dispatchYield(context, block2);
            }
        } catch (RejectedExecutionException e2) {
            block2 = block;
        }
