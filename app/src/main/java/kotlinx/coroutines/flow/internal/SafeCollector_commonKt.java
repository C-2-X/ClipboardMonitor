...
public final class SafeCollector_commonKt {
    ...
    public static final Job transitiveCoroutineParent(Job $this$transitiveCoroutineParent, Job collectJob) {
        ...
        while (parent$kotlinx_coroutines_core != null) {
            if (parent$kotlinx_coroutines_core == collectJob || !(parent$kotlinx_coroutines_core instanceof ScopeCoroutine)) {
                return parent$kotlinx_coroutines_core;
            }
            parent$kotlinx_coroutines_core = ((ScopeCoroutine) parent$kotlinx_coroutines_core).getParent$kotlinx_coroutines_core();
        }
        return null;
    }
