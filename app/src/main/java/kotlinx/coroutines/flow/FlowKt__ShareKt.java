            ...
            switch (((ChannelFlow) flow).capacity) {
                ...
                case 0:
                    if (((ChannelFlow) flow).onBufferOverflow == BufferOverflow.SUSPEND) {
                        i = ((ChannelFlow) flow).capacity != 0 ? defaultExtraCapacity : 0;
                    } else if (replay != 0) {
                        i = 0;
                    }
                    break;
