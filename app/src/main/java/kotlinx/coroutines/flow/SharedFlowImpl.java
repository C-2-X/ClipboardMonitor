...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x00a9 A[Catch: all -> 0x00d7, TryCatch #0 {all -> 0x00d7, blocks: (B:13:0x003c, B:30:0x00a0, B:32:0x00a9, B:37:0x00be, B:38:0x00c1, B:16:0x0054, B:19:0x0066, B:28:0x008e, B:22:0x0076, B:24:0x007a), top: B:46:0x0021 }] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:41:0x00d3 -> B:29:0x009d). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r7, kotlinx.coroutines.flow.FlowCollector r8, kotlin.coroutines.Continuation r9) throws java.lang.Throwable {
        /*
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m170constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (!tryEmitLocked(t)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m170constructorimpl(Unit.INSTANCE));
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m170constructorimpl(Unit.INSTANCE));
            }
        }
        Object resumes = cancellable$iv.getResult();
        if (resumes == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
        return resumes == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? resumes : Unit.INSTANCE;
    }
        ...
        if (((AbstractSharedFlow) this_$iv).nCollectors != 0 && ($this$forEach$iv$iv = ((AbstractSharedFlow) this_$iv).slots) != null) {
            ...
            while (i < length) {
                ...
                if (element$iv$iv == null || (continuation = (slot = (SharedFlowSlot) element$iv$iv).cont) == null || sharedFlowImpl.tryPeekLocked(slot) < 0) {
                    ...
                    if (resumeCount2 >= ((Object[]) resumes).length) {
                        resumeCount = resumeCount2;
                        int resumeCount4 = ((Object[]) resumes).length * 2;
                        Object objCopyOf = Arrays.copyOf((Object[]) resumes, Math.max(2, resumeCount4));
