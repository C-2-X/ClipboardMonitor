...
final class FlowKt__ReduceKt$reduce$2$emit$1 extends ContinuationImpl {
    ...
    final /* synthetic */ FlowKt__ReduceKt.C01032<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    FlowKt__ReduceKt$reduce$2$emit$1(FlowKt__ReduceKt.C01032<? super T> c01032, Continuation<? super FlowKt__ReduceKt$reduce$2$emit$1> continuation) {
        super(continuation);
        this.this$0 = c01032;
    }
