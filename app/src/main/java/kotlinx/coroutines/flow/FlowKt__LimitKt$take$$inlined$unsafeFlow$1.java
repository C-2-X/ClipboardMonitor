    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        ...
        L2c:
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L35
            goto L5e
        L35:
            r2 = move-exception
            goto L62
        L37:
            ...
            r4.<init>()
            kotlinx.coroutines.flow.Flow r5 = r2.$this_take$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r6 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            int r7 = r2.$count$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            r6.<init>(r4, r7, r9)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            ...
            r0.L$0 = r9     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            r7 = 1
            r0.label = r7     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            java.lang.Object r5 = r5.collect(r6, r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5f
            if (r5 != r1) goto L5c
            return r1
        L5c:
            r1 = r9
