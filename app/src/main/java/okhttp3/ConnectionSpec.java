...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1751deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1753deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuites) {
            ...
            String[] strings = (String[]) $this$toTypedArray$iv.toArray(new String[0]);
