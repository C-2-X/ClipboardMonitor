...
public final class Response implements Closeable {
    ...
    public final CacheControl m1842deprecated_cacheControl() {
        return cacheControl();
    }
