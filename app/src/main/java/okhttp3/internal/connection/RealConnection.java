...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    public final void connect(int r15, int r16, int r17, int r18, boolean r19, okhttp3.Call r20, okhttp3.EventListener r21) throws java.lang.Throwable {
        /*
    ...
    private final void establishProtocol(ConnectionSpecSelector connectionSpecSelector, int pingIntervalMillis, Call call, EventListener eventListener) throws Throwable {
        if (this.route.address().sslSocketFactory() == null) {
            boolean zContains = this.route.address().protocols().contains(Protocol.H2_PRIOR_KNOWLEDGE);
            Socket socket = this.rawSocket;
            if (zContains) {
                this.socket = socket;
