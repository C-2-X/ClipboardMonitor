    ...
    */
    public final synchronized okhttp3.Headers takeHeaders() throws java.io.IOException {
        /*
            r2 = this;
            monitor-enter(r2)
            okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r2.readTimeout     // Catch: java.lang.Throwable -> L53
            r0.enter()     // Catch: java.lang.Throwable -> L53
        L7:
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch: java.lang.Throwable -> L4c
        ...
        L19:
            okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r2.readTimeout     // Catch: java.lang.Throwable -> L53
            r0.exitAndThrowIfTimedOut()     // Catch: java.lang.Throwable -> L53
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch: java.lang.Throwable -> L53
            java.util.Collection r0 = (java.util.Collection) r0     // Catch: java.lang.Throwable -> L53
            ...
            okhttp3.Headers r0 = (okhttp3.Headers) r0     // Catch: java.lang.Throwable -> L53
            monitor-exit(r2)
            return r0
        L38:
            java.io.IOException r0 = r2.errorException     // Catch: java.lang.Throwable -> L53
            if (r0 == 0) goto L3f
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch: java.lang.Throwable -> L53
            goto L4b
        L3f:
            okhttp3.internal.http2.StreamResetException r0 = new okhttp3.internal.http2.StreamResetException     // Catch: java.lang.Throwable -> L53
            okhttp3.internal.http2.ErrorCode r1 = r2.errorCode     // Catch: java.lang.Throwable -> L53
        ...
        L4c:
            r0 = move-exception
        L4d:
            okhttp3.internal.http2.Http2Stream$StreamTimeout r1 = r2.readTimeout     // Catch: java.lang.Throwable -> L53
            r1.exitAndThrowIfTimedOut()     // Catch: java.lang.Throwable -> L53
            throw r0     // Catch: java.lang.Throwable -> L53
        L53:
            r0 = move-exception
    ...
    public final class FramingSource implements Source {
        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            while (true) {
                ...
                long unacknowledgedBytesRead = -1;
                ...
                synchronized (http2Stream) {
                    ...
                    try {
                        ...
                        if (this.readBuffer.size() > j) {
                            long readBytesDelivered = this.readBuffer.read(sink, Math.min(byteCount, this.readBuffer.size()));
                            try {
                                http2Stream2.setReadBytesTotal$okhttp(http2Stream2.getReadBytesTotal() + readBytesDelivered);
                                long unacknowledgedBytesRead2 = http2Stream2.getReadBytesTotal() - http2Stream2.getReadBytesAcknowledged();
                                if (errorExceptionToDeliver == null && unacknowledgedBytesRead2 >= http2Stream2.getConnection().getOkHttpSettings().getInitialWindowSize() / 2) {
                                    http2Stream2.getConnection().writeWindowUpdateLater$okhttp(http2Stream2.getId(), unacknowledgedBytesRead2);
                ...
                if (!tryAgain) {
                    if (unacknowledgedBytesRead != -1) {
                        return unacknowledgedBytesRead;
                    }
    ...
    public final class FramingSink implements Sink {
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        private final void emitFrame(boolean r17) throws java.lang.Throwable {
            /*
                r16 = this;
                r1 = r16
                r2 = 0
                ...
                monitor-enter(r5)
                r7 = 0
                okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r6.getWriteTimeout()     // Catch: java.lang.Throwable -> Lad
                r0.enter()     // Catch: java.lang.Throwable -> Lad
            L13:
                long r8 = r6.getWriteBytesTotal()     // Catch: java.lang.Throwable -> La4
                long r10 = r6.getWriteBytesMaximum()     // Catch: java.lang.Throwable -> La4
                int r0 = (r8 > r10 ? 1 : (r8 == r10 ? 0 : -1))
                if (r0 < 0) goto L31
                boolean r0 = r1.finished     // Catch: java.lang.Throwable -> La4
                if (r0 != 0) goto L31
                boolean r0 = r1.closed     // Catch: java.lang.Throwable -> La4
                if (r0 != 0) goto L31
                okhttp3.internal.http2.ErrorCode r0 = r6.getErrorCode$okhttp()     // Catch: java.lang.Throwable -> La4
                if (r0 != 0) goto L31
                r6.waitForIo$okhttp()     // Catch: java.lang.Throwable -> La4
                goto L13
            L31:
                okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r6.getWriteTimeout()     // Catch: java.lang.Throwable -> Lad
                r0.exitAndThrowIfTimedOut()     // Catch: java.lang.Throwable -> Lad
                r6.checkOutNotClosed$okhttp()     // Catch: java.lang.Throwable -> Lad
                long r8 = r6.getWriteBytesMaximum()     // Catch: java.lang.Throwable -> Lad
                long r10 = r6.getWriteBytesTotal()     // Catch: java.lang.Throwable -> Lad
                long r8 = r8 - r10
                okio.Buffer r0 = r1.sendBuffer     // Catch: java.lang.Throwable -> Lad
                long r10 = r0.size()     // Catch: java.lang.Throwable -> Lad
                long r8 = java.lang.Math.min(r8, r10)     // Catch: java.lang.Throwable -> Lad
                r14 = r8
                long r2 = r6.getWriteBytesTotal()     // Catch: java.lang.Throwable -> La1
                long r2 = r2 + r14
                r6.setWriteBytesTotal$okhttp(r2)     // Catch: java.lang.Throwable -> La1
                if (r17 == 0) goto L66
                okio.Buffer r0 = r1.sendBuffer     // Catch: java.lang.Throwable -> La1
                long r2 = r0.size()     // Catch: java.lang.Throwable -> La1
            ...
            L67:
                ...
                r0.enter()
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this     // Catch: java.lang.Throwable -> L92
                okhttp3.internal.http2.Http2Connection r10 = r0.getConnection()     // Catch: java.lang.Throwable -> L92
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this     // Catch: java.lang.Throwable -> L92
                int r11 = r0.getId()     // Catch: java.lang.Throwable -> L92
                okio.Buffer r13 = r1.sendBuffer     // Catch: java.lang.Throwable -> L92
                r10.writeData(r11, r12, r13, r14)     // Catch: java.lang.Throwable -> L92
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r0.getWriteTimeout()
            ...
            L92:
                ...
                okhttp3.internal.http2.Http2Stream$StreamTimeout r2 = r2.getWriteTimeout()
            ...
            La4:
                r0 = move-exception
                okhttp3.internal.http2.Http2Stream$StreamTimeout r6 = r6.getWriteTimeout()     // Catch: java.lang.Throwable -> Lad
                r6.exitAndThrowIfTimedOut()     // Catch: java.lang.Throwable -> Lad
    ...
    /* JADX INFO: compiled from: Http2Stream.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0014J\b\u0010\b\u001a\u00020\u0004H\u0014¨\u0006\t"}, d2 = {"Lokhttp3/internal/http2/Http2Stream$StreamTimeout;", "Lokio/AsyncTimeout;", "(Lokhttp3/internal/http2/Http2Stream;)V", "exitAndThrowIfTimedOut", HttpUrl.FRAGMENT_ENCODE_SET, "newTimeoutException", "Ljava/io/IOException;", "cause", "timedOut", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
