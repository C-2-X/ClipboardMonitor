        ...
        public final void callbackSuccessAsync(final Typeface typeface, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat$FontCallback$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m16x46c88379(typeface);
                }
            });
        }
    ...
    */
    ...
    public static final class ThemeCompat {
        ...
        static class Api23Impl {
            ...
            /* JADX WARN: Removed duplicated region for block: B:19:0x003d A[Catch: all -> 0x003f, DONT_GENERATE, TryCatch #2 {, blocks: (B:4:0x0003, B:8:0x0009, B:12:0x0024, B:11:0x001d, B:13:0x0026, B:15:0x002a, B:19:0x003d, B:18:0x0033), top: B:28:0x0003, inners: #0, #1 }] */
            ...
            */
            static void rebase(android.content.res.Resources.Theme r6) {
                /*
                    ...
                    monitor-enter(r0)
                    boolean r1 = androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethodFetched     // Catch: java.lang.Throwable -> L3f
                    r2 = 0
                    if (r1 != 0) goto L26
                    r1 = 1
                    java.lang.Class<android.content.res.Resources$Theme> r3 = android.content.res.Resources.Theme.class
                    java.lang.String r4 = "rebase"
                    java.lang.Class[] r5 = new java.lang.Class[r2]     // Catch: java.lang.NoSuchMethodException -> L1c java.lang.Throwable -> L3f
                    java.lang.reflect.Method r3 = r3.getDeclaredMethod(r4, r5)     // Catch: java.lang.NoSuchMethodException -> L1c java.lang.Throwable -> L3f
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethod = r3     // Catch: java.lang.NoSuchMethodException -> L1c java.lang.Throwable -> L3f
                    java.lang.reflect.Method r3 = androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethod     // Catch: java.lang.NoSuchMethodException -> L1c java.lang.Throwable -> L3f
                    r3.setAccessible(r1)     // Catch: java.lang.NoSuchMethodException -> L1c java.lang.Throwable -> L3f
                    goto L24
                L1c:
                    r3 = move-exception
                    java.lang.String r4 = "ResourcesCompat"
                    java.lang.String r5 = "Failed to retrieve rebase() method"
                    android.util.Log.i(r4, r5, r3)     // Catch: java.lang.Throwable -> L3f
                L24:
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethodFetched = r1     // Catch: java.lang.Throwable -> L3f
                L26:
                    java.lang.reflect.Method r1 = androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethod     // Catch: java.lang.Throwable -> L3f
                    if (r1 == 0) goto L3d
                    java.lang.reflect.Method r1 = androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethod     // Catch: java.lang.Throwable -> L32 java.lang.Throwable -> L3f
                    java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch: java.lang.Throwable -> L32 java.lang.Throwable -> L3f
                    r1.invoke(r6, r2)     // Catch: java.lang.Throwable -> L32 java.lang.Throwable -> L3f
                    goto L3d
                L32:
                    r1 = move-exception
                    java.lang.String r2 = "ResourcesCompat"
                    java.lang.String r3 = "Failed to invoke rebase() method via reflection"
                    android.util.Log.i(r2, r3, r1)     // Catch: java.lang.Throwable -> L3f
                    r2 = 0
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.Api23Impl.sRebaseMethod = r2     // Catch: java.lang.Throwable -> L3f
                L3d:
