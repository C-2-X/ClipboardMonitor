...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(int r, int g, int b, double[] outXyz) {
        ...
        outXyz[0] = ((0.4124d * sr) + (0.3576d * sg) + (0.1805d * sb2)) * XYZ_WHITE_REFERENCE_Y;
        outXyz[1] = ((0.2126d * sr) + (0.7152d * sg) + (0.0722d * sb2)) * XYZ_WHITE_REFERENCE_Y;
        outXyz[2] = ((0.0193d * sr) + (0.1192d * sg) + (0.9505d * sb2)) * XYZ_WHITE_REFERENCE_Y;
    }
