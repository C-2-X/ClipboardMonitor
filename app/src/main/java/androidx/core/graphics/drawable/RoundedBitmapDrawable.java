    ...
    void updateDstRect() {
        ...
        if (this.mApplyGravity) {
            if (this.mIsCircular) {
                ...
                int insetX = Math.max(0, (roundedBitmapDrawable.mDstRect.width() - minDrawDimen) / 2);
                int insetY = Math.max(0, (roundedBitmapDrawable.mDstRect.height() - minDrawDimen) / 2);
                roundedBitmapDrawable.mDstRect.inset(insetX, insetY);
                roundedBitmapDrawable.mCornerRadius = minDrawDimen * 0.5f;
            } else {
                roundedBitmapDrawable = this;
