...
public class NotificationCompat {
        ...
        */
        static androidx.core.app.NotificationCompat.Style constructCompatStyleByName(java.lang.String r1) {
            /*
                ...
                int r0 = r1.hashCode()
                switch(r0) {
                    case -716705180: goto L32;
                    case -171946061: goto L28;
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            contentView.setViewVisibility(R.id.line3, showLine3 ? 0 : i);
            return contentView;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            Notification.MessagingStyle frameworkStyle = new Notification.MessagingStyle(this.mUser.toAndroidPerson());
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            int color2 = 1 != 0 ? ViewCompat.MEASURED_STATE_MASK : -1;
            Person person = message.getPerson();
            CharSequence text = HttpUrl.FRAGMENT_ENCODE_SET;
            CharSequence replyName = person == null ? HttpUrl.FRAGMENT_ENCODE_SET : message.getPerson().getName();
        ...
        public static final class Message {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                Notification.MessagingStyle.Message frameworkMessage = new Notification.MessagingStyle.Message(getText(), getTimestamp(), person == null ? null : person.toAndroidPerson());
    ...
    public static class Action {
        ...
        public IconCompat getIconCompat() {
            if (this.mIcon == null && this.icon != 0) {
                this.mIcon = IconCompat.createWithResource(null, HttpUrl.FRAGMENT_ENCODE_SET, this.icon);
            }
            return this.mIcon;
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle b) {
            ...
            if (remoteInput != null) {
                remoteInputCompat = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getEditChoicesBeforeSending(), remoteInput.getExtras(), null);
            } else {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                remoteInputs2[i] = new RemoteInput(src.getResultKey(), src.getLabel(), src.getChoices(), src.getAllowFreeFormInput(), src.getEditChoicesBeforeSending(), src.getExtras(), null);
            }
