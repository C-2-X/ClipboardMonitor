...
public final class ContentInfoCompat {
    ...
    private static final class CompatImpl implements Compat {
        ...
        public String toString() {
            StringBuilder sbAppend = new StringBuilder().append("ContentInfoCompat{clip=").append(this.mClip.getDescription()).append(", source=").append(ContentInfoCompat.sourceToString(this.mSource)).append(", flags=").append(ContentInfoCompat.flagsToString(this.mFlags));
            Uri uri = this.mLinkUri;
            String str = HttpUrl.FRAGMENT_ENCODE_SET;
            StringBuilder sbAppend2 = sbAppend.append(uri == null ? HttpUrl.FRAGMENT_ENCODE_SET : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")");
