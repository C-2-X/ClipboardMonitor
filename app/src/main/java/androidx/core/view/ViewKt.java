...
public final class ViewKt {
    ...
    public static final OneShotPreDrawListener doOnPreDraw(final View $this$doOnPreDraw, final Function1<? super View, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        OneShotPreDrawListener oneShotPreDrawListenerAdd = OneShotPreDrawListener.add($this$doOnPreDraw, new Runnable() { // from class: androidx.core.view.ViewKt.doOnPreDraw.1
    ...
    public static final Runnable postOnAnimationDelayed(View $this$postOnAnimationDelayed, long delayInMillis, final Function0<Unit> action) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.m34postOnAnimationDelayed$lambda1(action);
            }
        };
    ...
    public static final void m34postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
