                ...
                switch (msg.what) {
                    ...
                    case 3:
                        if (GestureDetectorCompatImplBase.this.mDoubleTapListener != null) {
                            boolean z = GestureDetectorCompatImplBase.this.mStillDown;
                            GestureDetectorCompatImplBase gestureDetectorCompatImplBase = GestureDetectorCompatImplBase.this;
                            if (!z) {
                                gestureDetectorCompatImplBase.mDoubleTapListener.onSingleTapConfirmed(GestureDetectorCompatImplBase.this.mCurrentDownEvent);
                                return;
                            } else {
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            switch (action & 255) {
                ...
                case 2:
                    ...
                    int skipIndex2 = this.mTouchSlopSquare;
                    if (distance > skipIndex2) {
