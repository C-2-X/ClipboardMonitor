...
class DocumentsContractApi19 {
    ...
    public static boolean exists(Context context, Uri self) throws Throwable {
        Throwable th;
        Exception e;
    ...
    private static String queryForString(Context context, Uri self, String column, String defaultValue) throws Throwable {
        Throwable th;
        Exception e;
        ContentResolver resolver = context.getContentResolver();
        Cursor c = null;
    ...
    private static long queryForLong(Context context, Uri self, String column, long defaultValue) throws Throwable {
        Throwable th;
        Exception e;
        ContentResolver resolver = context.getContentResolver();
        Cursor c = null;
    ...
    private static void closeQuietly(AutoCloseable closeable) {
        if (closeable != null) {
            try {
                DocumentsContractApi19$$ExternalSyntheticAutoCloseableDispatcher0.m(closeable);
