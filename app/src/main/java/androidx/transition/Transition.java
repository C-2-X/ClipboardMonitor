    ...
    protected void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues, TransitionValuesMaps endValues, ArrayList<TransitionValues> startValuesList, ArrayList<TransitionValues> endValuesList) {
                    ...
                    if (animator3 != null) {
                        if (end != null) {
                            ...
                            if (properties != null) {
                                ...
                                if (properties.length > 0) {
                                    infoValues3 = new TransitionValues(view2);
                                    startValuesListCount = startValuesListCount2;
                                    i = i2;
                                    ...
                                    if (newValues != null) {
                                        ...
                                        while (j < properties.length) {
                                            ...
                                            int j2 = j;
                                            infoValues3.values.put(properties2[j], newValues.values.get(properties2[j2]));
                                            j = j2 + 1;
                        ...
                        if (animator != null) {
                            if (this.mPropagation != null) {
                                long delay2 = this.mPropagation.getStartDelay(sceneRoot, this, start, end);
        ...
        if (startDelays.size() != 0) {
            for (int i3 = 0; i3 < startDelays.size(); i3++) {
                ...
                long delay3 = (((long) startDelays.valueAt(i3)) - minStartDelay) + animator4.getStartDelay();
                animator4.setStartDelay(delay3);
            }
        }
    }
