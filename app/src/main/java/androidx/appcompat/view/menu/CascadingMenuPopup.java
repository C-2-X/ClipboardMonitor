...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        MenuAdapter adapter = new MenuAdapter(menu, layoutInflaterFrom, this.mOverflowOnly, ITEM_LAYOUT);
        ...
        if (parentView != null) {
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                ...
                x = showOnRight ? parentView.getWidth() + 0 : 0 - menuWidth;
            }
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) layoutInflaterFrom.inflate(R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
