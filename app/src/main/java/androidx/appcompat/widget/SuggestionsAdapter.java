...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        String query = constraint == null ? HttpUrl.FRAGMENT_ENCODE_SET : constraint.toString();
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Uri.Builder uriBuilder = new Uri.Builder().scheme(ClipboardProxyActivity.EXTRA_CONTENT).authority(authority).query(HttpUrl.FRAGMENT_ENCODE_SET).fragment(HttpUrl.FRAGMENT_ENCODE_SET);
