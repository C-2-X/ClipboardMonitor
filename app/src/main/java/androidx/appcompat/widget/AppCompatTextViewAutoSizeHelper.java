...
class AppCompatTextViewAutoSizeHelper {
    ...
    private static final class Api16Impl {
        ...
        static StaticLayout createStaticLayoutForMeasuring(CharSequence text, Layout.Alignment alignment, int availableWidth, TextView textView, TextPaint tempTextPaint) {
            ...
            float lineSpacingAdd = textView.getLineSpacingExtra();
            boolean includePad = textView.getIncludeFontPadding();
            return new StaticLayout(text, tempTextPaint, availableWidth, alignment, lineSpacingMultiplier, lineSpacingAdd, includePad);
        }
    }
}
