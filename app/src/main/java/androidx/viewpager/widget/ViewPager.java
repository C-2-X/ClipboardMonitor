                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                if (!lp2.needsMeasure) {
                                    ...
                                    count = count2;
                                    int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childWidth2 * lp2.widthFactor), BasicMeasure.EXACTLY);
                                    childWidth = childWidth2;
                                    int childWidth3 = (height4 - paddingTop) - paddingBottom;
                                    int heightSpec = View.MeasureSpec.makeMeasureSpec(childWidth3, BasicMeasure.EXACTLY);
