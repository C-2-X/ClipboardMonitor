        ...
        void apply() {
            if (this.startState != -1 || this.endState != -1) {
                if (this.startState == -1) {
                    ...
                    if (i == -1) {
                        motionLayout.setState(this.startState, -1, -1);
                    } else {
                        motionLayout.setTransition(this.startState, this.endState);
                    }
                }
    ...
    */
    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String a = HttpUrl.FRAGMENT_ENCODE_SET + (child.mTop.mTarget != null ? "T" : "_");
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((int) ((len * 100.0f) / dist)) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((double) ((xgap * 100.0f) / Math.abs(x2 - x1))) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((double) ((ygap * 100.0f) / Math.abs(y2 - y1))) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((double) (((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth))) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((double) (((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight))) + 0.5d)) / 100.0f);
            getTextBounds(text2, this.mTextPaint);
    ...
    void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        String idName = v == null ? HttpUrl.FRAGMENT_ENCODE_SET + mTouchAnchorId : v.getContext().getResources().getResourceName(mTouchAnchorId);
    ...
    private void fireTransitionChange() {
        if ((this.mTransitionListener != null || (this.mTransitionListeners != null && !this.mTransitionListeners.isEmpty())) && this.mListenerPosition != this.mTransitionPosition) {
            ...
            if (this.mTransitionListeners != null) {
                for (TransitionListener listeners2 : this.mTransitionListeners) {
