...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        */
        public final void measure(androidx.constraintlayout.core.widgets.ConstraintWidget r31, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measure r32) {
            /*
    ...
    private boolean updateHierarchy() throws IllegalAccessException {
    ...
    private void setChildrenConstraints() throws IllegalAccessException {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean sameSpecsAsPreviousMeasure = this.mDirtyHierarchy;
        if (!sameSpecsAsPreviousMeasure && 0 == 0) {
            int count = getChildCount();
            int i = 0;
            while (true) {
                if (i >= count) {
