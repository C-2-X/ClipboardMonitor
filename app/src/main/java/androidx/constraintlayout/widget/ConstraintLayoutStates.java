    ...
    */
    private void load(android.content.Context r9, int r10) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            ...
            r3 = 0
            r4 = 0
            int r5 = r1.getEventType()     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
        Lf:
            r6 = 1
            if (r5 == r6) goto L88
            switch(r5) {
                ...
                case 3: goto L17;
                default: goto L15;
            }     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
        L15:
            goto L82
        L17:
            r3 = 0
            goto L82
        L1a:
            java.lang.String r7 = r1.getName()     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r3 = r7
            int r7 = r3.hashCode()     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            switch(r7) {
        ...
        L27:
            ...
            boolean r6 = r3.equals(r6)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            if (r6 == 0) goto L26
            r6 = 3
            goto L59
        L31:
        ...
        L3b:
            ...
            boolean r7 = r3.equals(r7)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            if (r7 == 0) goto L26
            goto L59
        L44:
        ...
        L5c:
            goto L7c
        L5d:
            r8.parseConstraintSet(r9, r1)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            goto L7c
        L61:
            androidx.constraintlayout.widget.ConstraintLayoutStates$Variant r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$Variant     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r6.<init>(r9, r1)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            if (r4 == 0) goto L7c
            r4.add(r6)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            goto L7c
        L6c:
            androidx.constraintlayout.widget.ConstraintLayoutStates$State r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$State     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r6.<init>(r9, r1)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r4 = r6
            android.util.SparseArray<androidx.constraintlayout.widget.ConstraintLayoutStates$State> r6 = r8.mStateList     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            int r7 = r4.mId     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r6.put(r7, r4)     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            goto L7c
        L7a:
            goto L7c
        L7b:
        L7c:
            goto L82
        L7d:
            java.lang.String r6 = r1.getName()     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r2 = r6
        L82:
            int r6 = r1.next()     // Catch: java.io.IOException -> L89 org.xmlpull.v1.XmlPullParserException -> L8e
            r5 = r6
            goto Lf
        L88:
            goto L92
