    ...
    public void onPreSetup(MotionLayout motionLayout, HashMap<View, MotionController> controllerMap) {
        ...
        while (i9 < views2.length) {
            ...
            if (mc2 == null) {
                ...
                } else if (i4 == i5 && x2 > 0.0f && (!this.motionEffectStrictMove || y2 == 0.0f)) {
                    apply = false;
                }
                if (!apply) {
                    views = views2;
                    ...
                    if (this.viewTransitionId == -1) {
                        ...
                        motionLayout.applyViewTransition(this.viewTransitionId, mc2);
                    }
                }
            }
            i9++;
