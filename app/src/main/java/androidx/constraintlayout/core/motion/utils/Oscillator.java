...
public class Oscillator {
    ...
    double getP(double time) {
        ...
        double p = this.mArea[index2 - 1] + ((((double) this.mPeriod[index2 - 1]) - (this.mPosition[index2 - 1] * m)) * (t - this.mPosition[index2 - 1])) + ((((t * t) - (this.mPosition[index2 - 1] * this.mPosition[index2 - 1])) * m) / 2.0d);
        return p;
    }
    ...
    double getDP(double time) {
        ...
        double t = time;
        double m = ((double) (this.mPeriod[index2] - this.mPeriod[index2 - 1])) / (this.mPosition[index2] - this.mPosition[index2 - 1]);
        double p = (m * t) + (((double) this.mPeriod[index2 - 1]) - (this.mPosition[index2 - 1] * m));
        return p;
    }
