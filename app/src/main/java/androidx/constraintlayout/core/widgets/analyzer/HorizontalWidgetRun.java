                    ...
                    if (this.widget.mMatchConstraintDefaultHeight == 0 || this.widget.mMatchConstraintDefaultHeight == 3) {
                        ...
                        if (!s1 || !s2 || !e1 || !e2) {
                            ...
                            if (secondStart.resolved && secondEnd.resolved) {
                                if (this.start.readyToSolve && this.end.readyToSolve) {
                                    computeInsetRatio(tempDimensions, this.start.margin + this.start.targets.get(0).value, this.end.targets.get(0).value - this.end.margin, secondStart.margin + secondStart.value, secondEnd.value - secondEnd.margin, ratio3, definedSide);
                            ...
                            if (!this.start.resolved || !this.end.resolved) {
                                ...
                                computeInsetRatio(tempDimensions, this.start.margin + this.start.value, this.end.value - this.end.margin, secondStart.margin + secondStart.targets.get(0).value, secondEnd.targets.get(0).value - secondEnd.margin, ratio3, definedSide);
                                f = 0.5f;
                                this.dimension.resolve(tempDimensions[0]);
                                this.widget.verticalRun.dimension.resolve(tempDimensions[1]);
                            } else {
                            ...
                            if (this.start.readyToSolve && this.end.readyToSolve && secondStart.readyToSolve && secondEnd.readyToSolve) {
                                computeInsetRatio(tempDimensions, this.start.margin + this.start.targets.get(0).value, this.end.targets.get(0).value - this.end.margin, secondStart.margin + secondStart.targets.get(0).value, secondEnd.targets.get(0).value - secondEnd.margin, ratio3, definedSide);
                                this.dimension.resolve(tempDimensions[0]);
                                this.widget.verticalRun.dimension.resolve(tempDimensions[1]);
                            } else {
                                return;
