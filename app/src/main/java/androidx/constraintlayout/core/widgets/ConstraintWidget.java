...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = sb.append(str != null ? "type: " + this.mType + " " : HttpUrl.FRAGMENT_ENCODE_SET);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + " ";
        }
        return sbAppend.append(str2).append("(").append(this.mX).append(", ").append(this.mY).append(") - (").append(this.mWidth).append(" x ").append(this.mHeight).append(")").toString();
    }
