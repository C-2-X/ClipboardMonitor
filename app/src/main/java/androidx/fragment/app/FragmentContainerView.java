...
public final class FragmentContainerView extends FrameLayout {
        ...
        if (name != null && existingFragment == null) {
            if (id <= 0) {
                if (tag != null) {
                    ...
                    tagMessage = HttpUrl.FRAGMENT_ENCODE_SET;
                }
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        ...
        if (this.mApplyWindowInsetsListener != null) {
            dispatchInsets = WindowInsetsCompat.toWindowInsetsCompat(this.mApplyWindowInsetsListener.onApplyWindowInsets(this, insets));
        } else {
    ...
    private void addDisappearingFragmentView(View v) {
        if (this.mTransitioningFragmentViews != null && this.mTransitioningFragmentViews.contains(v)) {
