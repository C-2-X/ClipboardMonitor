...
class FragmentTransition {
    ...
    private static void configureTransitionsOrdered(ViewGroup container, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides, final Callback callback) {
        ...
        ArrayList<View> exitingViews = configureEnteringExitingViews(impl, exitTransition, outFragment, sharedElementsOut, nonExistentView);
        Object exitTransition2 = (exitingViews == null || exitingViews.isEmpty()) ? null : exitTransition;
    ...
    private static Object configureSharedElementsReordered(final FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Object enterTransition, Object exitTransition) {
        ...
        final Rect epicenter2 = epicenter;
        OneShotPreDrawListener.add(sceneRoot, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.5
            ...
            public void run() {
                ...
                if (epicenterView != null) {
                    impl.getBoundsOnScreen(epicenterView, epicenter2);
                }
            }
        });
    ...
    private static Object configureSharedElementsOrdered(final FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, final ArrayMap<String, String> nameOverrides, final FragmentContainerTransition fragments, final ArrayList<View> sharedElementsOut, final ArrayList<View> sharedElementsIn, final Object enterTransition, Object exitTransition) {
        Object sharedElementTransition;
        View view;
        Object sharedElementTransition2;
        Rect inEpicenter;
        ...
        if (sharedElementTransition != null) {
            ...
            impl.setSharedElementTargets(sharedElementTransition, view, sharedElementsOut);
            boolean outIsPop = fragments.firstOutIsPop;
            BackStackRecord outTransaction = fragments.firstOutTransaction;
            Object sharedElementTransition3 = sharedElementTransition;
            setOutEpicenter(impl, sharedElementTransition3, exitTransition, outSharedElements, outIsPop, outTransaction);
            ...
            public void run() {
                ...
                if (finalSharedElementTransition != null) {
                    ...
                    if (inEpicenterView != null) {
                        impl.getBoundsOnScreen(inEpicenterView, inEpicenter2);
                    }
                }
            }
        });
    ...
    private static ArrayMap<String, View> captureOutSharedElements(FragmentTransitionImpl fragmentTransitionImpl, ArrayMap<String, String> nameOverrides, Object sharedElementTransition, FragmentContainerTransition fragments) {
        ...
        fragmentTransitionImpl.findNamedViews(outSharedElements, outFragment.requireView());
        BackStackRecord outTransaction = fragments.firstOutTransaction;
    ...
    static ArrayMap<String, View> captureInSharedElements(FragmentTransitionImpl fragmentTransitionImpl, ArrayMap<String, String> nameOverrides, Object sharedElementTransition, FragmentContainerTransition fragments) {
        SharedElementCallback sharedElementCallback;
        ArrayList<String> names;
        String key;
        Fragment inFragment = fragments.lastIn;
