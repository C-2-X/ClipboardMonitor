...
public final class InitializerViewModelFactoryBuilder {
    ...
    public final ViewModelProvider.Factory build() {
        Collection $this$toTypedArray$iv = this.initializers;
        ViewModelInitializer[] viewModelInitializerArr = (ViewModelInitializer[]) $this$toTypedArray$iv.toArray(new ViewModelInitializer[0]);
