...
public final class UStringsKt {
    ...
    public static final String m1498toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1497toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1495toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m265constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m182boximpl(UByte.m188constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m265constructorimpl(65535)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m265constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m265constructorimpl(result * uradix);
            result = UInt.m265constructorimpl(UInt.m265constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m259boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m344constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m344constructorimpl(result * uradix);
            result = ULong.m344constructorimpl(ULong.m344constructorimpl(((long) UInt.m265constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m338boximpl(result);
    }
}
