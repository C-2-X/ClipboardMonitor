...
public final class Buffer {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final long commonReadDecimalLong(okio.Buffer r22) throws java.io.EOFException {
        /*
    ...
    */
    ...
    public static final int commonReadUtf8CodePoint(okio.Buffer $this$commonReadUtf8CodePoint) throws EOFException {
        ...
        if ($this$commonReadUtf8CodePoint.size() < codePoint) {
        ...
        for (int i = 1; i < codePoint; i++) {
            ...
            int other$iv6 = 192 & b;
            if (other$iv6 == 128) {
                int codePoint2 = other$iv << 6;
                int other$iv7 = 63 & b;
                other$iv = codePoint2 | other$iv7;
            } else {
                $this$commonReadUtf8CodePoint.skip(i);
                return Utf8.REPLACEMENT_CODE_POINT;
            }
        }
        $this$commonReadUtf8CodePoint.skip(codePoint);
        if (other$iv > 1114111) {
            return Utf8.REPLACEMENT_CODE_POINT;
        }
        boolean z = false;
    ...
    public static final long commonIndexOf(okio.Buffer $this$commonIndexOf, byte b, long fromIndex, long toIndex) {
        ...
        long j = -1;
        if (fromIndex != toIndex2 && (s$iv = ($this$seek$iv = $this$commonIndexOf).head) != null) {
            if ($this$seek$iv.size() - fromIndex < fromIndex) {
                long offset$iv = $this$seek$iv.size();
                while (offset$iv > fromIndex) {
                    long j2 = j;
                    Segment segment = s$iv.prev;
                    Intrinsics.checkNotNull(segment);
                    s$iv = segment;
                ...
                while (offset2 < toIndex2) {
                    ...
                    int limit = (int) Math.min(s2.limit, (((long) s2.pos) + toIndex3) - offset2);
            ...
            while (offset4 < toIndex4) {
                ...
                int limit2 = (int) Math.min(s4.limit, (((long) s4.pos) + toIndex4) - offset4);
    ...
    public static final long commonIndexOf(okio.Buffer $this$commonIndexOf, ByteString bytes, long fromIndex) {
        ...
        if ($this$seek$iv.size() - fromIndex$iv < fromIndex$iv) {
            ...
            while (offset2 < resultLimit) {
                ...
                for (int pos = (int) ((((long) s2.pos) + fromIndex2) - offset2); pos < a$iv2; pos++) {
        ...
        while (offset4 < resultLimit2) {
            ...
            long offset5 = offset3;
            Segment s6 = s4;
            long b$iv2 = (((long) s5.pos) + resultLimit2) - offset4;
            int i2 = i;
            int $i$f$minOf = (int) Math.min(a$iv3, b$iv2);
            for (int pos3 = (int) ((((long) s5.pos) + fromIndex4) - offset4); pos3 < $i$f$minOf; pos3++) {
                if (data2[pos3] == b02 && rangeEquals(s5, pos3 + 1, targetByteArray2, 1, bytesSize2)) {
                    return ((long) (pos3 - s5.pos)) + offset4;
                }
            }
            int pos4 = s5.limit;
            offset4 += (long) (pos4 - s5.pos);
    ...
    public static final long commonIndexOfElement(okio.Buffer $this$commonIndexOfElement, ByteString targetBytes, long fromIndex) {
        ...
        if ($this$seek$iv.size() - fromIndex >= fromIndex) {
            ...
            if (targetBytes.size() == 2) {
                ...
                while (offset2 < $this$commonIndexOfElement.size()) {
                    ...
                    long offset$iv3 = s2.pos;
                    int limit = s2.limit;
                    for (int pos = (int) ((offset$iv3 + fromIndex2) - offset2); pos < limit; pos++) {
                        int b = data[pos];
                        if (b == b0 || b == b1) {
                            int pos2 = pos;
                            int pos3 = s2.pos;
                            return ((long) (pos2 - pos3)) + offset2;
                        }
                    }
                    int pos4 = s2.limit;
                    offset2 += (long) (pos4 - s2.pos);
                    fromIndex2 = offset2;
                    Segment segment2 = s2.next;
                    Intrinsics.checkNotNull(segment2);
                    s2 = segment2;
                ...
                while (offset2 < $this$commonIndexOfElement.size()) {
                    byte[] data2 = s2.data;
                    int pos5 = (int) ((((long) s2.pos) + fromIndex3) - offset2);
                    int limit2 = s2.limit;
                    while (pos5 < limit2) {
                        byte b2 = data2[pos5];
                        byte[] data3 = data2;
                        ...
                        while (i < length) {
                            ...
                            if (b2 == t) {
                                return ((long) (pos5 - s2.pos)) + offset2;
                            }
                            i = i2 + 1;
                        }
                        pos5++;
        ...
        long offset$iv4 = $this$seek$iv.size();
        while (offset$iv4 > fromIndex) {
            Segment segment4 = s$iv.prev;
            Intrinsics.checkNotNull(segment4);
            s$iv = segment4;
            offset$iv4 -= (long) (s$iv.limit - s$iv.pos);
            j = j;
        }
        long j2 = j;
        Segment s3 = s$iv;
        long offset3 = offset$iv4;
        if (s3 == null) {
            return j2;
        }
        long offset4 = offset3;
        if (targetBytes.size() == 2) {
            ...
            while (offset4 < buffer.size()) {
                ...
                byte[] data4 = s4.data;
                int b3 = (int) ((((long) s4.pos) + fromIndex4) - offset4);
                int limit3 = s4.limit;
                while (b3 < limit3) {
                    int pos6 = b3;
                    int pos7 = data4[pos6];
                    if (pos7 == b02 || pos7 == b12) {
                        int b4 = s4.pos;
                        return ((long) (pos6 - b4)) + offset4;
                    }
                    b3 = pos6 + 1;
                }
                int pos8 = s4.limit;
                offset4 += (long) (pos8 - s4.pos);
                fromIndex4 = offset4;
            ...
            while (offset4 < $this$commonIndexOfElement.size()) {
                byte[] data5 = s5.data;
                int pos9 = (int) ((((long) s5.pos) + fromIndex5) - offset4);
                int limit4 = s5.limit;
                while (pos9 < limit4) {
                    byte b5 = data5[pos9];
                    okio.Buffer $this$seek$iv2 = $this$seek$iv;
                    ...
                    while (i3 < length2) {
                        ...
                        if (b5 == t2) {
                            return ((long) (pos9 - s5.pos)) + offset4;
                        }
                        i3 = i4 + 1;
                    }
                    pos9++;
    ...
    public static final ByteString commonSnapshot(okio.Buffer $this$commonSnapshot, int byteCount) {
        ...
        return new C0112SegmentedByteString(segments, directory);
    }
