            ...
            if (Intrinsics.areEqual(part, DOT_DOT)) {
                if (!absolute || !canonicalParts.isEmpty()) {
                    if (normalize) {
                        if (absolute) {
                            j2 = j;
                        } else if (!canonicalParts.isEmpty()) {
                            j2 = j;
                            if (Intrinsics.areEqual(CollectionsKt.last(canonicalParts), DOT_DOT)) {
