...
public final class ZipFilesKt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x01a9, code lost:
        ...
        r3 = new okio.ZipFileSystem(r31, r32, buildIndex(r0), r0);
     */
    ...
    */
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        ...
        Map<Path, ZipEntry> mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.to(root, new ZipEntry(root, true, null, 0L, 0L, 0L, 0, null, 0L, TypedValues.PositionType.TYPE_CURVE_FIT, null)));
    ...
    public static final ZipEntry readEntry(final BufferedSource $this$readEntry) throws IOException {
        ...
        offset.element = ((long) $this$readEntry.readIntLe()) & MAX_ZIP_ENTRY_AND_ARCHIVE_SIZE;
