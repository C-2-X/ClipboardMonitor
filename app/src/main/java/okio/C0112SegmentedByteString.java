...
public final class C0112SegmentedByteString extends ByteString {
    ...
    public C0112SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C0112SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0112SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0112SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0112SegmentedByteString $this$commonRangeEquals$iv = this;
        ...
        while (pos$iv$iv < endIndex$iv$iv) {
            ...
            C0112SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0112SegmentedByteString $this$commonCopyInto$iv = this;
